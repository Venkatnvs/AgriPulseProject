...
export const deleteFieldApi = id =>
  AXIOS_INSTANCE.delete(`/core/fields/${id}/`);

export const fetchWeatherAndForecastApi = formData =>
  AXIOS_INSTANCE.post('/core/fields/weather-and-forecast/', formData);

export const fetchFieldsForSelectApi = (device_id) =>
  AXIOS_INSTANCE.get(`/core/fields/${device_id}/select-list/`);

export const linkDeviceApi = (fieldId, deviceId) =>
  AXIOS_INSTANCE.post(`/core/fields/${fieldId}/link-device/`, {
    device_id: deviceId,
  });
